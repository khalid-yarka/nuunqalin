...
from db import get_student_by_id, is_admin
...
def update_notifications():
    user_id = session['user_id']
    data = request.get_json() or {}
    # List of allowed notification keys
    notif_keys = [
        'notify_quiz_complete', 'notify_live_quiz_start', 'notify_live_quiz_result',
        'notify_admin_announcement', 'notify_participant_joined', 'notify_new_pdf'
    ]
    updates = {}
...
def change_password():
    ...
    # Force logout (client will handle)
